...
// Given 1000 digits of PI as strings, return an array of the digits as numbers. call map function inside
const stringsToNumbs = (numbers) => numbers.map(x => Number(x));
// With the same numbers, find the sum of the even values
const num = stringToNumbs(strNums);
//first convert the array of string to the array of number. we will use the new array. then we will search the new array for even numbers. each time i find an even number, i make an accumulation. we can use filter to return only even numbers and then create the call function sum. 
